...
@register_model
def  vit_base_patch16_224_in21k(pretrained=True, adapter=False, **kwargs):
...
@register_model
def  vit_base_patch16_224_in21k_cil(pretrained=True, adapter=False, **kwargs):
    """ ViT-Base model (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    NOTE: this model has valid 21k classifier head and no representation (pre-logits) layer
    """
...
def vit_base_patch16_224_mocov3(pretrained=False, adapter=False, **kwargs):
    ...
    del model.head
    ckpt = torch.load('./pretrained/mocov3-vit-base-300ep.pth', map_location='cpu')['model']
...
@register_model
def  vit_tiny_patch16_224_in21k(pretrained=True, adapter=False, **kwargs):
    """ ViT-Base model (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    NOTE: this model has valid 21k classifier head and no representation (pre-logits) layer
    """
    ...
    model = _create_vision_transformer('vit_tiny_patch16_224_in21k', pretrained=pretrained, **dict(model_args, **kwargs))
    del model.head
    del model.norm
    model.norm = nn.LayerNorm(192)
    return model

@register_model
def  vit_large_patch16_224_in21k(pretrained=True, adapter=False, **kwargs):
    """ ViT-Base model (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    NOTE: this model has valid 21k classifier head and no representation (pre-logits) layer
    """
    ...
    model = _create_vision_transformer('vit_large_patch16_224_in21k', pretrained=pretrained, **dict(model_args, **kwargs))
    del model.head
    del model.norm
    model.norm = nn.LayerNorm(1024)
    return model

@register_model
def  vit_base_patch16_sam_224(pretrained=True, adapter=False, **kwargs):
    """ ViT-Base model (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    NOTE: this model has valid 21k classifier head and no representation (pre-logits) layer
    """
...
@register_model
def vit_base_patch16_dinov2(pretrained=True, **kwargs) -> VisionTransformer:
    """ ViT-B/14 for DINOv2
    """
    #model = timm.create_model('vit_large_patch14_dinov2.lvd142m', pretrained=pretrained)
    import timm
    model = timm.create_model(
        'vit_base_patch16_224_in21k', pretrained=pretrained)
    ckpt = torch.load('./pretrained/dino_vitbase16_pretrain.pth', map_location='cpu')
    model.load_state_dict(ckpt, strict=True)

    return model

@register_model
def vit_base_patch16_224_clip(pretrained=True, adapter=False, **kwargs):
    """ ViT-Base model (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    NOTE: this model has valid 21k classifier head and no representation (pre-logits) layer
    """
    #try this also : vit_base_patch16_clip_224.openai_ft_in1k
    model_kwargs = dict(
        patch_size=16, embed_dim=768, depth=12, num_heads=12, with_adapter=adapter, **kwargs)
    model = _create_vision_transformer('vit_base_patch16_clip_224.openai_ft_in1k', pretrained=pretrained, **model_kwargs)
    del model.head
    del model.norm
    model.norm = nn.LayerNorm(768)
    return model
...
@register_model
def vit_base_patch16_224_mae(pretrained=True, adapter=False, **kwargs):
    model_kwargs = dict(
        patch_size=16, embed_dim=768, depth=12, num_heads=12, with_adapter=adapter, **kwargs)
    model = _create_vision_transformer('vit_base_patch16_224_in21k', pretrained=pretrained, **model_kwargs)
    del model.head

    ckpt = torch.load('./pretrained/mae_pretrain_vit_base.pth', map_location='cpu')['model']
    state_dict = model.state_dict()
    state_dict.update(ckpt)
